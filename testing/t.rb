...
def weekly_comparisons
  ...
  Dictionary.offense_codes.each do |code, offense|
    ...
    state_weekly_data = Research::Incidents.weekly state_data
    ...
    agencies_data.each do |agency|
      ...
      agency_weekly_data = Research::Incidents.weekly agency_data
      # Create a weekly dataset
	...
	line_colors: ['1565c0', 'c62828'],
        ...
        axis_range: [[0, 52, 52 / 10], [0, state_weekly_array.max, state_weekly_array.max / 10]],
        size: '500x500',
        filename: file
      )
      g.file
